...
import { PhotoGridBackground } from "@/components/ui/PhotoGridBackground";
  ...
  return (
    <div className="relative">
      ...
      {/* Featured Experiences */}
        {featuredExperiences.length > 0 && (
          <section className="container py-16 md:py-24">
            <div className="flex items-center justify-between mb-8">
              ...
              <Link href="/experiences" className="body-text hover:text-[var(--color-primary-black)] transition-colors">
                View All →
              </Link>
            </div>
        ...
        <section className="bg-white/70 backdrop-blur-sm py-16 md:py-24">
          <div className="container">
            <h2 className="heading-2 text-center mb-12">How It Works</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="w-16 h-16 rounded-full bg-[var(--color-primary-black)] text-white flex items-center justify-center text-2xl font-bold mx-auto mb-4">
                  1
                </div>
